...
export function TransfersView({
  ...
  const pending = state.transfers.artifacts.filter((artifact) =>
    transferArtifactNeedsAttention(state, artifact),
  );
...
function ArtifactItem({
  ...
  const needsAttention = transferArtifactNeedsAttention(state, artifact);
  const decisionLabel = transferArtifactDecisionLabel(state, artifact);
  return (
    <SummaryItem
