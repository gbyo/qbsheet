          ...
          <div className="director-form-grid director-form-grid-single">
            ...
            <label className="director-check-row">
              <input
                ...
                onChange={(event) => controller.updateFormat({ avoidSameOrganization: event.target.checked })}
              />
            ...
            {state.phases.map((entry) => (
              <li key={entry.id}>
                ...
                <div>
                  ...
                  <small>
                    {entry.kind} · {state.rounds.filter((round) => entry.roundIds.includes(round.id)).length}{' '}
                    generated round
