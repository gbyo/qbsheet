  ...
  state.games = [
    {
      ...
      playerStats: [
        { playerId: 'player-a1', teamId: 'team-a', superpowers: 0, powers: 2, gets: 5, negs: 0, bonusPoints: 0, tossupsHeard: 20 },
        { playerId: 'player-a2', teamId: 'team-a', superpowers: 0, powers: 0, gets: 3, negs: 0, bonusPoints: 0, tossupsHeard: 20 },
        { playerId: 'player-c1', teamId: 'team-c', superpowers: 0, powers: 0, gets: 6, negs: 1, bonusPoints: 0, tossupsHeard: 20 },
      ],
      source: 'manual',
