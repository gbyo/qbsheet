          ...
          <div className="director-round-actions">
            <Button
              ...
              onClick={() => {
                ...
                onAnnounce(
                  round.status === 'released' ? `${round.name} close requested.` : `${round.name} released.`,
                );
              }}
            >
      ...
      <div className="director-two-column">
                    ...
                    return (
                      <tr key={room.id}>
                        ...
                        <td>
                          <StateLabel
                            state={
                              session?.state === 'live' || game?.status === 'live' ? 'live' : room.status
                            }
                            label={
        ...
        <section className="director-panel">
          ...
          {standings.length === 0 ? (
            ...
            <ol className="director-leader-list">
