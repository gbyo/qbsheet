 ...
 */
export default function PracticeSummary(props: { onRestart: () => void; onHome: () => void; onDrill: () => void }) {
  ...
  return (
    <main className="shell practice-complete">
      ...
      <section className="shell-section practice-next">
        ...
        <p>
          Every ruling you just recorded with a button also has a key behind it, and a scorekeeper who knows them
          scores a tossup in two keystrokes without looking away from the room. The drill is the layout on its own —
          the seats, the four rulings, no buzz, a bonus total, undo and redo — in about a minute. No game is scored
