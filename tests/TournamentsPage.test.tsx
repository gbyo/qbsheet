...
describe('the tournaments page', () => {
  ...
  test('marks the links that leave the site, and lands the wordmark on this site', () => {
    ...
    // Both product entries are pages on this site now, one directory across from this one. None
    // is a jump into an application: Director is not deployed here at all, and QBLive is
