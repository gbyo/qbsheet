...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::director_list_tournaments,
            commands::director_read_tournament,
            commands::director_open_tournament,
            commands::director_save_state,
            commands::director_save_document,
            commands::director_checkpoint,
            commands::director_list_checkpoints,
            commands::director_read_checkpoint,
