/**
 * The original room workflow: the scorekeeper picks a round and two teams by hand.
 *
 * Still the right answer for a tournament that hasn't set up rooms and a schedule, and for a spare
 * laptop pressed into service mid-morning. `AssignedRoomApp` is what a paired Chromebook uses.
 */
...
export default function ManualRoomApp() {
